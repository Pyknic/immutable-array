...
public interface ShortImmutableArray {
     ...
     */
    short getAsShort(long index);
    
    /**
     * Returns the length of the array (the number of shorts that can safely
     * be retrieved using the {@link #getAsShort(long)} method).
     * 
     * @return  the length
     */
    long length();
    ...
    /**
     * A builder for a {@link ShortImmutableArray}. The builder can be appended
     * with values using the {@link #append(short)}-method until it is finalized
     ...
     * amount of shorts as well as a very small amount.
     */
    interface Builder {
         ...
         */
        ShortImmutableArray.Builder append(short value);
